...
const caseStudyData = {
    'Shop in 3D': {
        pages: [
            {
                title: 'The Problem',
                text: 'The pandemic shut down Microsoft retail stores, severing the physical connection to Surface products. Static 2D image galleries failed to communicate build quality. The initial business requirement was to create a 3D screen-sharing tool for Customer Service agents, but we soon realized the UX needed to be intuitive enough for a fully self-service customer experience. The biggest threat was scope creep. With multiple organizations (Store, Surface, MSCOM) heavily invested, I had to pivot my role from just designing UI to actively defending the core user experience against a barrage of competing feature requests.'
            },
            {
                title: 'The Constraints',
                text: 'We initially explored using external vendors, but their platforms failed to meet our strict accessibility standards, only hitting an AA rating. I made the strategic call to bring the architecture in-house using Babylon.js to give us granular control over rendering and system resources. Embedding a 3D canvas into a standard webpage also introduced severe UX friction, most notably the "scroll trap" where users would accidentally zoom into a model instead of scrolling down the page. I had to design custom zoom limits, cursor "grab" affordances, and a full-screen breakout mode to protect the traditional shopping flow. On the performance side, I manually optimized 8GB CAD manufacturing models down to a strict 5MB limit, ensuring the experience loaded instantly on 4G networks.'
            },
            {
                title: 'The Iteration',
                text: 'To prove the concept without crashing browsers, I had to ruthlessly prioritize. I worked with our engineer to strip out the Chatbot, pricing, and universal headers for the Proof of Concept, focusing purely on core sales scenarios like checking ports and screen sizes. I also engineered a DOM hierarchy that allowed keyboard tabbing through the 3D space, ensured high-visibility focus states, and changed "hotspots" to screen-reader-friendly "POIs". To handle the entire Surface lineup without memory leaks, I prototyped loading mechanics using AssetContainers to cache and dynamically swap meshes. My coded prototype ultimately served as the sole source of truth for the engineering team.'
            },
            {
                title: 'The Outcome',
